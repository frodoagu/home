...
| [aire-chicos-slwf01pro.md](aire-chicos-slwf01pro.md) | Fourth AC (Philco iView) over Wi-Fi with a SMLIGHT SLWF-01pro module: checking whether the unit is Midea inside, install, flashing, DHCP reservation, HA onboarding, and the SmartIR fallback |
